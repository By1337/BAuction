...
public class SellItemTest extends TestCase {
    ...
    public void testParse() {
        SellItem sellItem1 = SellItem.parse(sellItem);
        Assert.assertEquals(sellItem1, sellItem);
    }

    public void testFromBytes() throws IOException {
        SellItem sellItem1 = SellItem.fromBytes(sellItem.getBytes());
        Assert.assertEquals(sellItem1, sellItem);
    }

    public void testFromResultSet() throws SQLException {
        SellItem sellItem1 = SellItem.fromResultSet(createResultSet());
        Assert.assertEquals(sellItem1, sellItem);
    }
