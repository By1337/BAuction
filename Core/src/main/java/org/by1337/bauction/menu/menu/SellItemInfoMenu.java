...
public class SellItemInfoMenu extends Menu {
    private SellItem item;
    protected User user;

    public SellItemInfoMenu(MenuSetting setting, Player player, @Nullable Menu previousMenu, OptionParser optionParser) {
