...
public class EventSellItem extends Event {
     ...
     */
    public EventSellItem(@NotNull PluginUser user, @NotNull PluginSellItem sellItem) {
        this.user = user;
     ...
     * @param sellItem The item that has been successfully listed for sale.
     */
    public EventSellItem(boolean isAsync, @NotNull PluginUser user, @NotNull PluginSellItem sellItem) {
        super(isAsync);
        this.user = user;
        this.sellItem = sellItem;
    }
