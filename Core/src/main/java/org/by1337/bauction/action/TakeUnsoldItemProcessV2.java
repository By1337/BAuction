...
public class TakeUnsoldItemProcessV2 extends Placeholder {
    private final Menu menu;
    private final User taker;
    private @Nullable
    final UnsoldItem takingItem;

    public TakeUnsoldItemProcessV2(Menu menu, User taker, @Nullable UnsoldItem takingItem) {
        this.menu = menu;
        this.taker = taker;
    ...
    public TakeUnsoldItemProcessV2(Menu menu) {
        this.menu = menu;
    ...
    public String toString() {
        return "TakeUnsoldItemProcessV2{" +
                "menu=" + menu +
                ", taker=" + taker +
