...
public class TakeUnsoldItemProcess {
    private final CUnsoldItem takingItem;
    private final CUser taker;
    private final Menu menu;
    private final Player player;
    private final boolean fast;

    public TakeUnsoldItemProcess(@NotNull CUnsoldItem takingItem, @NotNull CUser taker, Menu menu, Player player, boolean fast) {
