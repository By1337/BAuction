...
public class UnsoldItem extends Placeholder implements SerializableToByteArray {
    ...
    public static UnsoldItem fromResultSet(ResultSet resultSet) throws SQLException {
        ...
        return new UnsoldItem(item, expired, UUID.fromString(sellerUuidString), uniqueName, deleteVia, compressed);
    }

    public UnsoldItem(String item, long expired, UUID sellerUuid, UniqueName uniqueName, long deleteVia, boolean compressed) {
        this.item = item;
    ...
    public UnsoldItem(String item, long expired, UUID sellerUuid, UniqueName uniqueName, long deleteVia, @Nullable ItemStack itemStack, boolean compressed) {
        this.item = item;
        this.expired = expired;
        this.sellerUuid = sellerUuid;
        this.uniqueName = uniqueName;
    ...
    public static UnsoldItem fromBytes(byte[] arr) throws IOException {
